...
SELECT D.DEPTNO,D.DNAME, AVG (E.SAL) AS AVG_SALARY, max(E.SAL) AS MAX_SALARY
FROM EMPLOYEE E 
JOIN DEPT D ON E.DEPTNO=D.DEPTNO
...
SELECT M.EMPNO AS MANAGER_ID , M.ENAME AS MANAGER_NAME,count(E.EMPNO) AS DIRECT_REPORTS
FROM EMPLOYEE M
